...
#### 2.不同付款方式與不同使用平台，與總價格的關係
#### 3.不同付款方式與不同使用平台，與總數量的關係
#### 4.不同付款方式與不同使用裝置，與總價格的關係
#### 5.不同付款方式與不同使用裝置，與總數量的關係
#### 6.總價格與總數量的關係
#### 7.ShoppingCarts.csv每月總營收
#### 8.ShoppingCarts.csv週間訂單數
#### 9.PromotionOrders.csv與TargetOrders.csv合併、清理、視覺化
#### 10.各優惠折扣歷史總使用次數
#### 11.各優惠折扣每月使用次數
